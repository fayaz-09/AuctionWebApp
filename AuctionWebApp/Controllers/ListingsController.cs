...
using AuctionWebApp.Data.Services;
    ...
    public class ListingsController : Controller
    {
        ...
        public async Task<IActionResult> Create(ListingViewModel listing)
        {
            if(listing.Images != null)
            {
                ...
                string fileName = listing.Images.FileName;
                string filePath = Path.Combine(uploadDir, fileName);
                using (var fileStream = new FileStream(filePath, FileMode.Create))
                {
                    listing.Images.CopyTo(fileStream);
                }
        ...
        //    [HttpPost]
        //    [ValidateAntiForgeryToken]
        //    public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Price,Image,IsSold,IdentityUserId")] Listing listing)
        //    {
        //        if (id != listing.Id)
        //        {
        //            return NotFound();
